...
// Mock dos componentes ShadCN para funcionar no VSCode
// Substitua estas implementações pelas versões reais do ShadCN após instalação
const Button = ({ children, className = '', size = 'default', variant = 'default', onClick, ...props }: any) => {
  const sizeClasses = {
    default: 'px-4 py-2',
  ...
  return (
    <button
      className={`inline-flex items-center justify-center rounded-md font-medium transition-colors focus:outline-none focus:ring-2 focus:ring-ring disabled:opacity-50 disabled:pointer-events-none ${sizeClasses[size]} ${variantClasses[variant]} ${className}`}
      onClick={onClick}
      {...props}
    >
      {children}
...
const images = {
  hero: "https://images.unsplash.com/photo-1714629825960-75fd2154d700?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxlbGVnYW50JTIwbGluZ2VyaWUlMjBtb2RlbCUyMGx1eHVyeXxlbnwxfHx8fDE3NTYzMDgyMzV8MA&ixlib=rb-4.1.0&q=80&w=1080",
  redLace: "https://images.unsplash.com/photo-1646231383225-48d6a48f5db9?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHxyZWQlMjBsYWNlJTIwbGluZ2VyaWUlMjBlbGVnYW50fGVufDF8fHx8MTc1NjMwODIzOHww&ixlib=rb-4.1.0&q=80&w=1080",
  pinkRomance: "https://images.unsplash.com/photo-1697652440819-32ae57842e4c?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxwaW5rJTIwcm9tYW5jZSUyMGxpbmdlcmllJTIwZGVsaWNhdGV8ZW58MXx8fHwxNzU2MzA4MjQyfDA&ixlib=rb-4.1.0&q=80&w=1080",
  blackSet: "https://images.unsplash.com/photo-1584061677142-c729839e341f?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxibGFjayUyMGxhY2UlMjBsaW5nZXJpZSUyMGx1eHVyeXxlbnwxfHx8fDE3NTYzMDgyNDZ8MA&ixlib=rb-4.1.0&q=80&w=1080",
  greenDelicate: "https://images.unsplash.com/photo-1636545659284-0481a5aab979?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxncmVlbiUyMGRlbGljYXRlJTIwbGluZ2VyaWUlMjBlbGVnYW50fGVufDF8fHx8MTc1NjMwODI0OXww&ixlib=rb-4.1.0&q=80&w=1080",
  luxury: "https://images.unsplash.com/photo-1750268746235-1657249daa37?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxsdXh1cnklMjBiZWRyb29tJTIwZmVtaW5pbmUlMjBlbGVnYW50fGVufDF8fHx8MTc1NjMwODI1Mnww&ixlib=rb-4.1.0&q=80&w=1080",
  contact: "https://images.unsplash.com/photo-1551468307-8c1e3c78013c?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxtaW5pbWFsaXN0JTIwZWxlZ2FudCUyMHRleHR1cmUlMjBmYWJyaWN8ZW58MXx8fHwxNzU2MzA4MjU2fDA&ixlib=rb-4.1.0&q=80&w=1080"
};
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div 
                ...
                style={{ backgroundImage: `url('${images.blackSet}')` }}
              />
              <div 
                className="h-64 bg-cover bg-center rounded-lg shadow-lg"
                style={{ backgroundImage: `url('${images.greenDelicate}')` }}
              />
            </div>
          </div>
        </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="grid grid-cols-2 gap-4">
              <div 
                ...
                style={{ backgroundImage: `url('${images.redLace}')` }}
              />
